    ...
    <div class="col-md-12">
        <div class="box box-default" >
            <div class="box-header with-border">
                <h3 class="box-sold"><i class="fa fa-university"></i> Create House</h3>
            </div>
            <div class="box-body"> 

                {!! Form::open(['url'=>'house', 'enctype'=>'multipart/form-data']) !!}
                <div class="col-md-6">
...
<!--                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        {!! Form::submit('Create House', ['id' => 'photo', 'class'=>'btn btn-primary']) !!}
                    </div>
                </div>
                {!! Form::close() !!}    
            </div>
